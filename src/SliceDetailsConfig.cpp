...
void ConfigHelper::CreateDefaultConfig(ConfigDocument& config){
    ...
    getConfig().Write();
    config.AddMember("pausePosX", 0.0f, config.GetAllocator());
    config.AddMember("pausePosY", 1.0f, config.GetAllocator());
    config.AddMember("pausePosZ", 1.0f, config.GetAllocator());
    config.AddMember("pauseRotX", 0.0f, config.GetAllocator());
    config.AddMember("pauseRotY", 0.0f, config.GetAllocator());
    config.AddMember("pauseRotZ", 0.0f, config.GetAllocator());
    getConfig().Write();
    config.AddMember("resultPosX", 0.0f, config.GetAllocator());
    config.AddMember("resultPosY", 1.0f, config.GetAllocator());
    config.AddMember("resultPosZ", 1.0f, config.GetAllocator());
    config.AddMember("resultRotX", 0.0f, config.GetAllocator());
    config.AddMember("resultRotY", 0.0f, config.GetAllocator());
    config.AddMember("resultRotZ", 0.0f, config.GetAllocator());
    getConfig().Write();
}