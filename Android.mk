...
include $(CLEAR_VARS)
LOCAL_MODULE := beatsaber-hook_3_7_4
LOCAL_EXPORT_C_INCLUDES := extern/beatsaber-hook
LOCAL_SRC_FILES := extern/libbeatsaber-hook_3_7_4.so
LOCAL_CPP_FEATURES += exceptions
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: codegen - version: 0.13.0
include $(CLEAR_VARS)
LOCAL_MODULE := codegen_0_21_0
...
include $(CLEAR_VARS)
LOCAL_MODULE := slicedetails
LOCAL_SRC_FILES += $(call rwildcard,src/,*.cpp)
LOCAL_SRC_FILES += $(call rwildcard,extern/beatsaber-hook/src/inline-hook,*.cpp)
LOCAL_SRC_FILES += $(call rwildcard,extern/beatsaber-hook/src/inline-hook,*.c)
LOCAL_SHARED_LIBRARIES += modloader
LOCAL_SHARED_LIBRARIES += beatsaber-hook_3_7_4
LOCAL_SHARED_LIBRARIES += codegen_0_21_0
LOCAL_SHARED_LIBRARIES += questui
LOCAL_SHARED_LIBRARIES += custom-types
LOCAL_SHARED_LIBRARIES += codegen
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"slicedetails"' -DVERSION='"1.1.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
